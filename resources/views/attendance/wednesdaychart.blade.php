...
@section('title','Charts for Wednesday')


@section('content')

<div class="alert alert-success alert-dismissible fade show" role="alert">
    <strong>Welcome!</strong> Here you have the Charts and statistics for Wednesday Attendance
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>
<div id="all">
<div class="chart-container total">
    <h3> Line Chart for Total Attendance </h3>
    <h5> Wednesday Mean Attendance : <span id="TotalMean"></span></h5>
...
fetch('/bethelattendance/wednesdaychart', {
    method: 'GET',
})
